...
📝 Projetos: **Pokedash (Um dashboard interativo de Pokémon desenvolvido em Python)**, **Cyber Space (Um jogo de puzzles desenvolvido em React)** e **Codex of Epistemus (Um jogo roguelike criado com arte ASCII e desenvolvio em C)**
